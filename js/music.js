		...
		var music = function(){
			...
			var jsons = {
				...
				analyserMus : function(){
					...
					color.addColorStop(0,"#abcdef");/*天蓝色*/
					color.addColorStop(0.5,"#9bff00");/*浅绿色*/
					color.addColorStop(1,"#2196f3");/*蓝色*/

					colorf = cxt.createLinearGradient(can.width*.5,150,can.width*.5,250);
					colorf.addColorStop(0,"#ccc");/*灰色*/
					colorf.addColorStop(0.5,"#2196f3");/*蓝色*/
					colorf.addColorStop(1,"#f0023ee6");/*红色*/
					draw();
					function draw(){
